...
@Tag("probe")
public class JavaTextBlockManualSuiteProbe {
    ...
    @TableTest("""
            ...
            """)
    void modernTextBlockValidCorpus() {
    }
    ...
    void modernTextBlockCommentBeforeValue() {
    }

    @TableTest("""
            Scenario|Map literal|Result?
            second modern text block|[plain: other]|active
            quoted map key|["(s)u[c]c{e}ss": false]|shown
            """)
    void secondModernTextBlockShouldActivate() {
    }

    @org.tabletest.junit.TableTest("""
            Scenario|Map literal|Result?
            fully qualified modern|[plain: other]|active
            quoted key with punctuation|["[a]{b}(c),|": "(works)"]|shown
            """)
    void fullyQualifiedModernTextBlockShouldActivate() {
    }
    ...
    void annotationLikeTextInCommentsAndStringsShouldStayInactive() {
        ...
        // 1|2
        // """)
        String annotationLikeText = "@TableTest(\"\"\"\\na|b\\n1|2\\n\"\"\")";
        String similarAnnotationText = "@TableTestX(\"\"\"\\na|b\\n1|2\\n\"\"\")";
